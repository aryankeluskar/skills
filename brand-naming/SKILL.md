---
name: brand-naming
description: "Brand, product, company, startup, app, AI agent, feature, or project name generator and name evaluator — grounded in David Placek's (Lexicon Branding) methodology, the process behind Sonos, Pentium, Blackberry, Powerbook, Swiffer, Vercel, Windsurf, CapCut, and Azure. Use when the user wants to name, rename, brand, or rebrand anything, or says things like 'help me name X', 'brainstorm names', 'come up with a name', 'rename this', 'what should we call it', 'startup name ideas', 'product name suggestions', 'naming workshop'; or wants to pressure-test a candidate against trademark sanity, processing fluency, polarization, and sound symbolism. Two modes — QUICK (~50 candidates across coined/compound/metaphor/cross-domain buckets with rationales) and FULL (guided workshop: Diamond exercise → disguised briefs → screening → stakeholder shortlist). Skip for variable/function/file/symbol naming inside code unless the user explicitly wants brand treatment."
---
